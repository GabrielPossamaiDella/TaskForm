...
const LABELS = ['Cliente', 'Equip.', 'Serviço', 'Resumo'];
...
const styles = StyleSheet.create({
  ...
  num: { fontSize: 12, color: 'rgba(255,255,255,0.7)', fontWeight: '700' },
  numActive: { color: '#2563EB' },
  label: { fontSize: 11, color: 'rgba(255,255,255,0.7)', fontWeight: '600', textAlign: 'center' },
